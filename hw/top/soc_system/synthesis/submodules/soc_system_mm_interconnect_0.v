...
module soc_system_mm_interconnect_0 (
		...
		input  wire         accel_0_reset_sink_reset_bridge_in_reset_reset, // accel_0_reset_sink_reset_bridge_in_reset.reset
		input  wire [31:0]  accel_0_avalon_master_address,                  //                    accel_0_avalon_master.address
		output wire         accel_0_avalon_master_waitrequest,              //                                         .waitrequest
		input  wire         accel_0_avalon_master_read,                     //                                         .read
		output wire [31:0]  accel_0_avalon_master_readdata,                 //                                         .readdata
		input  wire         accel_0_avalon_master_write,                    //                                         .write
		input  wire [31:0]  accel_0_avalon_master_writedata                 //                                         .writedata
	);

	wire          accel_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // accel_0_avalon_master_agent:av_waitrequest -> accel_0_avalon_master_translator:uav_waitrequest
	wire   [31:0] accel_0_avalon_master_translator_avalon_universal_master_0_readdata;      // accel_0_avalon_master_agent:av_readdata -> accel_0_avalon_master_translator:uav_readdata
	wire          accel_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // accel_0_avalon_master_translator:uav_debugaccess -> accel_0_avalon_master_agent:av_debugaccess
	wire   [31:0] accel_0_avalon_master_translator_avalon_universal_master_0_address;       // accel_0_avalon_master_translator:uav_address -> accel_0_avalon_master_agent:av_address
	wire          accel_0_avalon_master_translator_avalon_universal_master_0_read;          // accel_0_avalon_master_translator:uav_read -> accel_0_avalon_master_agent:av_read
	wire    [3:0] accel_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // accel_0_avalon_master_translator:uav_byteenable -> accel_0_avalon_master_agent:av_byteenable
	wire          accel_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // accel_0_avalon_master_agent:av_readdatavalid -> accel_0_avalon_master_translator:uav_readdatavalid
	wire          accel_0_avalon_master_translator_avalon_universal_master_0_lock;          // accel_0_avalon_master_translator:uav_lock -> accel_0_avalon_master_agent:av_lock
	wire          accel_0_avalon_master_translator_avalon_universal_master_0_write;         // accel_0_avalon_master_translator:uav_write -> accel_0_avalon_master_agent:av_write
	wire   [31:0] accel_0_avalon_master_translator_avalon_universal_master_0_writedata;     // accel_0_avalon_master_translator:uav_writedata -> accel_0_avalon_master_agent:av_writedata
	wire    [2:0] accel_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // accel_0_avalon_master_translator:uav_burstcount -> accel_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                        // rsp_mux:src_valid -> accel_0_avalon_master_agent:rp_valid
	wire  [119:0] rsp_mux_src_data;                                                         // rsp_mux:src_data -> accel_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                        // accel_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                      // rsp_mux:src_channel -> accel_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                // rsp_mux:src_startofpacket -> accel_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                  // rsp_mux:src_endofpacket -> accel_0_avalon_master_agent:rp_endofpacket
	wire          accel_0_avalon_master_agent_cp_valid;                                     // accel_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [119:0] accel_0_avalon_master_agent_cp_data;                                      // accel_0_avalon_master_agent:cp_data -> router:sink_data
	wire          accel_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> accel_0_avalon_master_agent:cp_ready
	wire          accel_0_avalon_master_agent_cp_startofpacket;                             // accel_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          accel_0_avalon_master_agent_cp_endofpacket;                               // accel_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) accel_0_avalon_master_translator (
		.clk                    (ccd_pixel_clock_bridge_out_clk_clk),                                       //                       clk.clk
		.reset                  (accel_0_reset_sink_reset_bridge_in_reset_reset),                           //                     reset.reset
		.uav_address            (accel_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (accel_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (accel_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (accel_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (accel_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (accel_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (accel_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (accel_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (accel_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (accel_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (accel_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (accel_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (accel_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_read                (accel_0_avalon_master_read),                                               //                          .read
		.av_readdata            (accel_0_avalon_master_readdata),                                           //                          .readdata
		.av_write               (accel_0_avalon_master_write),                                              //                          .write
		.av_writedata           (accel_0_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) accel_0_avalon_master_agent (
		.clk                   (ccd_pixel_clock_bridge_out_clk_clk),                                       //       clk.clk
		.reset                 (accel_0_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		.av_address            (accel_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (accel_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (accel_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (accel_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (accel_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (accel_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (accel_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (accel_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (accel_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (accel_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (accel_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (accel_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (accel_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (accel_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (accel_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (accel_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_axi_slave_ni #(
		...
		.aclk                   (ccd_pixel_clock_bridge_out_clk_clk),                         //        clock_sink.clk
		.aresetn                (~accel_0_reset_sink_reset_bridge_in_reset_reset),            //        reset_sink.reset_n
	...
	soc_system_mm_interconnect_0_router router (
		.sink_ready         (accel_0_avalon_master_agent_cp_ready),           //      sink.ready
		.sink_valid         (accel_0_avalon_master_agent_cp_valid),           //          .valid
		.sink_data          (accel_0_avalon_master_agent_cp_data),            //          .data
		.sink_startofpacket (accel_0_avalon_master_agent_cp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (accel_0_avalon_master_agent_cp_endofpacket),     //          .endofpacket
		.clk                (ccd_pixel_clock_bridge_out_clk_clk),             //       clk.clk
		.reset              (accel_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
